...
namespace simple {
	...
	enum tokentype {
		...
		CUINT, CINT, CLONG, CULONG, CCHAR, CDOUBLE, CFLOAT,CSTRING,VOID,
	...
	// Unsupported: ++,-- and lots of other things.
	const string tokens[] = {
		"ERROR", "END", "IDENT", "SHORT", "LONG", "INT", "CHAR", "FLOAT", "DOUBLE","UNSIGNED INT","UNSIGNED LONG","UNSIGNED SHORT","UNSIGNED CHAR",
		"CUINT", "CINT", "CLONG", "CULONG", "CCHAR", "CDOUBLE", "CFLOAT", "CSTRING","VOID",
		"LP", "RP", "LB", "RB", "LC", "RC", "COMMA",
		"LT", "GT", "LE", "GE", "EQ", "NEQ", "OR", "AND", "ASSIGN","NOT","PLUS", "MINUS", "MULTIPLY", "DIVIDE", "MOD",
